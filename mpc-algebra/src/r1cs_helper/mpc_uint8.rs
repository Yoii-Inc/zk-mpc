...
impl<F: PrimeField, S: FieldShare<F>> MpcUInt8<F, S> {
    ...
    pub fn constant_vec(values: &[u8]) -> Vec<Self> {
        ...
        for value in values {
            result.push(MpcUInt8::constant(*value));
        }
        result
    }
    ...
    pub fn constant(value: u8) -> Self {
        ...
        for i in 0..8 {
            ...
            bits[i] = MpcBoolean::constant((tmp & 1) == 1);
            tmp >>= 1;
        }
...
// impl<ConstraintF: Field> EqGadget<ConstraintF> for MpcUInt8<ConstraintF> {
//     #[tracing::instrument(target = "r1cs")]
...
// impl<ConstraintF: Field> CondSelectGadget<ConstraintF> for MpcUInt8<ConstraintF> {
...
// impl<ConstraintF: PrimeField, S: FieldShare<ConstraintF>>
//     ToConstraintFieldGadget<MpcField<ConstraintF, S>> for [MpcUInt8<ConstraintF, S>]
// {
//     #[tracing::instrument(target = "r1cs")]
//     fn to_constraint_field(&self) -> Result<Vec<MpcFpVar<ConstraintF, S>>, SynthesisError> {
...
// impl<ConstraintF: PrimeField, S: FieldShare<ConstraintF>>
//     ToConstraintFieldGadget<MpcField<ConstraintF, S>> for Vec<MpcUInt8<ConstraintF, S>>
// {
//     #[tracing::instrument(target = "r1cs")]
//     fn to_constraint_field(&self) -> Result<Vec<MpcFpVar<ConstraintF, S>>, SynthesisError> {
